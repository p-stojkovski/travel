...
namespace TravelInspiration.API.Shared.Persistence.Migrations
{
    ...
    [Migration("20240804070943_SuggestedFieldAddedToStop")]
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7483),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7487),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7693),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7698),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7702),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7706),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7708),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 4, 7, 9, 43, 51, DateTimeKind.Utc).AddTicks(7711),
